...
describe('TestButtonComponent', () => {
  ...
  it('should have a name of "sentuh aku mas"', () => {
    fixture = TestBed.createComponent(TestButtonComponent);
    component = fixture.debugElement.componentInstance;
    expect(component.name).toBe('Sentuh saya mas')
  })
  ...
  it(`should create a button with name`, () => {
    ...
    expect(compiledElement.querySelector('button')?.textContent).toBe('Sentuh saya mas');
  })
});
